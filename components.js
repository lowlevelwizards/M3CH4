...
export const CATALOG = [
    ...
    { id: 'frame-utility', name: 'U-2 narrow utility hull', slot: 'structure', massKg: 1290, center: SLOT_CENTERS.structure, envelope: [1.55, 0.94, 1.46], accepts: 'U1', description: 'Narrow welded load frame with external weapon outrigger. Saves 290 kg, but its 4,120 kg load rating limits oversized builds.', powerKw: 0, loadLimitKg: 4120, functionReady: true },
    ...
    { id: 'cab-utility', name: 'Vista utility observation cab', slot: 'command', massKg: 295, center: SLOT_CENTERS.command, envelope: [1.14, 1.16, 1.10], accepts: 'U1', description: 'Narrow tall industrial pilot pod with an offset panoramic viewport. Lighter than Cyclops; view differences are visual until sensors arrive.', powerKw: -11, functionReady: true },
